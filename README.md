...
This package provides **Bitstamp exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITSTAMP** exchange.
...
```python
from bt_api_bitstamp import BitstampApi

# Initialize
feed = BitstampApi(api_key="your_key", secret="your_secret")
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **Bitstamp exchange plugin for bt_api**。它提供了与 **BITSTAMP** 交易所交互的统一接口。
